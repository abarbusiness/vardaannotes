...
// IMPORTANT: All backslashes in LaTeX must be double-escaped (e.g., \\rightarrow, \\text).
...
function insertQuestions(filePath, questionsHtml) {
    try {
        ...
        // Insertion Logic: after existing 31/4 questions if any, or before y2024.
        const last31_4 = content.lastIndexOf('31/4');

        let insertIndex = -1;

        // Find y2024 to insert before it
