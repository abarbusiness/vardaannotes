...
$wrongStr = @"
        <div class="formula-box">
            ...
            <p>For Real image:  is negative. For Virtual image:  is positive.</p>
        </div>
        ...
        <div class="practice-box">
            ...
            <p> = +60 \text{ cm} (Real image on other side).</p>
        </div>
        ...
        <div class="practice-box">
            ...
            <p> = -10 \text{ cm} (Virtual image on same side).</p>
        </div>
"@

# Since the previous string expansion removed all $ characters, and also backslash was probably preserved. Let me regex replace everything starting from <div class="formula-box"> MAGNIFICATION (M)

$content = $content -replace '(?s)        <div class="formula-box">\s*<div class="formula-pill">MAGNIFICATION \(M\).*?        </div>\s*</div>\s*<script>', ""
...
$content = $content -replace '(?s)        </div>\s*<script>', "        </div>`r`n`r`n$insertStr`r`n    </div>`r`n`r`n    <script>"
